                ...
                <div class="card-body box-profile">
                    ...
                    <form action="<?php echo base_url() ?>admin/Orders/updateOrderDetails" method="POST">
                        <ul class="list-group list-group-unbordered mb-3">
                            ...
                            <?php
                            if ($order_data->latitude != null) {
                            ?>
                                <li class="list-group-item">
                                    <b>Latitude</b> <span class="float-right"><?php echo $order_data->latitude; ?></span>
                                </li>
                            <?php
                            }
                            ?>
                            ...
                            <?php
                            if ($order_data->longitude != null) {
                            ?>
                                <li class="list-group-item">
                                    <b>Longitude</b> <span class="float-right"><?php echo $order_data->longitude; ?></span>
                                </li>
                            <?php
                            }
                            ?>
                            ...
                            <?php
                            if ($order_data->address != null) {
                            ?>
                                <li class="list-group-item">
                                    <b>Location</b> <span class="float-right"><?php echo $order_data->address; ?></span>
                                </li>
                            <?php
                            }
                            ?>
                            ...
                            <li class="list-group-item">
                                <b>Area</b> <span class="float-right"><?php echo $order_data->area_title; ?></span>
                            </li>
                            ...
                            <li class="list-group-item">
                                ...
                                <div>
                                    <b>Discount Value</b>
                                    <input name="discount_value_field" id="discount_value_field" type="number" class="form-control" value="<?php if ($order_data->discount != '') {
                                ...
                                <div class="mt-2">
                                    ...
                                    <select name="discount_type_field" id="discount_type_field" class="form-control">
                                        ...
                                        <option value="amount" <?php if ($order_data->discount_type == 'amount') {
                                                                    echo 'selected';
                                                                } ?>> Fixed Amount </option>
                                        <option value="percentage" <?php if ($order_data->discount_type == 'percentage') {
                                                                        echo 'selected';
                                                                    } ?>> Percentage </option>
                                    </select>
                                </div>
                                <div class="mt-2">
                                    <b>Tax Value</b>
                                    <input name="tax_value_field" id="tax_value_field" type="number" class="form-control" value="<?php if ($order_data->tax != '') {
                                                                                                                                        echo $order_data->tax;
                                                                                                                                    } else {
                                                                                                                                        echo 0;
                                                                                                                                    } ?>" min="0" />
                                ...
                                <div class="mt-2">
                                    ...
                                    <select name="tax_type_field" id="tax_type_field" class="form-control">
                                        ...
                                        <option value="amount" <?php if ($order_data->tax_type == 'amount') {
                                                                    echo 'selected';
                                                                } ?>> Fixed Amount </option>
                                        <option value="percentage" <?php if ($order_data->tax_type == 'percentage') {
                                                                        echo 'selected';
                                                                    } ?>> Percentage </option>
                                    </select>
                                </div>
                                <div class="mt-2">
                                    ...
                                    <select name="order_status_field" id="order_status_field" class="form-control">
                                        ...
                                        <option value="Submitted" <?php if ($order_data->order_status == 'Submitted') {
                                                                        echo 'selected';
                                                                    } ?>> Submitted </option>
                                        <option value="Accepted" <?php if ($order_data->order_status == 'Accepted') {
                                                                        echo 'selected';
                                                                    } ?>> Accepted </option>
                                        <option value="Ready" <?php if ($order_data->order_status == 'Ready') {
                                                                    echo 'selected';
                                                                } ?>> Ready </option>
                                        <option value="Serving" <?php if ($order_data->order_status == 'Serving') {
                                                                    echo 'selected';
                                                                } ?>> Serving </option>
                                        <option value="Completed" <?php if ($order_data->order_status == 'Completed') {
                                                                        echo 'selected';
                                                                    } ?>> Completed </option>
                                        <option value="Cancelled" <?php if ($order_data->order_status == 'Cancelled') {
                                                                        echo 'selected';
                                                                    } ?>> Cancelled </option>
                                    </select>
                                </div>
        ...
        <div class="col-md-8">
            <div class="card card-primary card-outline">
                <div class="card-header p-2">
                    <h3 class="profile-username text-center">Order Items</h3>
                </div>
                <div class="card-body box-profile">
