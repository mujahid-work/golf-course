...
<body class="hold-transition sidebar-mini layout-fixed">
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview">
              <a href="#" class="nav-link <?php if ($_SESSION['current_page'] == 'Categories') {
                                            echo 'active';
                                          } ?>">
            ...
            <li class="nav-item has-treeview">
              <a href="<?php echo base_url() ?>admin/items" class="nav-link <?php if ($_SESSION['current_page'] == 'Items') {
                                                                              echo 'active';
                                                                            } ?>">
            ...
            <li class="nav-item has-treeview">
              <a href="<?php echo base_url() ?>admin/chefs" class="nav-link <?php if ($_SESSION['current_page'] == 'Chefs') {
                                                                              echo 'active';
                                                                            } ?>">
                <i class="nav-icon fas fa-hat-cowboy-side" aria-hidden="true"></i>
                <p>
                  Manage Chefs
                </p>
              </a>
            ...
            <li class="nav-item has-treeview">
              <a href="<?php echo base_url() ?>admin/customers" class="nav-link <?php if ($_SESSION['current_page'] == 'Customers') {
                                                                                  echo 'active';
                                                                                } ?>">
            ...
            <li class="nav-item has-treeview">
              <a href="#" class="nav-link <?php if ($_SESSION['current_page'] == 'Orders') {
                                            echo 'active';
                                          } ?>">
            ...
            <li class="nav-item has-treeview">
              <a href="<?php echo base_url() ?>admin/events" class="nav-link <?php if ($_SESSION['current_page'] == 'Events') {
                                                                                echo 'active';
                                                                              } ?>">
            ...
            <li class="nav-item has-treeview">
              <a href="#" class="nav-link <?php if ($_SESSION['current_page'] == 'Seats') {
                                            echo 'active';
                                          } ?>">
  ...
  <script src="<?php echo base_url() ?>assets/dist/js/custom_js_files/events.js"></script>
