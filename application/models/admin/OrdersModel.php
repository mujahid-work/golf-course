<?php
    ...
    class OrdersModel extends CI_Model {
        ...
        public function fetchAllOrders(){
            ...
            ->join('users_tbl', 'users_tbl.id = sales_order_tbl.user_id' , 'left')
        ...
        public function fetchSingleOrder($order_id){
            ...
            $this->db->select("sales_order_tbl.* , users_tbl.full_name , seats_tbl.seat_no , seat_types_tbl.seat_type_title , areas_tbl.area_title");
            $this->db->from('sales_order_tbl')
            ->join('users_tbl', 'users_tbl.id = sales_order_tbl.user_id' , 'left')
            ->join('areas_tbl', 'areas_tbl.id = sales_order_tbl.area_id' , 'left')
            ->join('seats_tbl', 'seats_tbl.id = sales_order_tbl.seat_id' , 'left')
