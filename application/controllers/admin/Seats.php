...
class Seats extends CI_Controller
{
    ...
    public function addArea()
    {
        ...
        if (isset($_POST['area_add_btn'])) {
            ...
            if ($this->form_validation->run() == TRUE) {
                ...
                $last_inserted_id = $this->seats_m->addArea($area_data);

                $area_timings_data = array(
                    array(
                        'area_id' => $last_inserted_id,
                        'day' => 'Monday',
                        'opening' => $this->input->post('monday_opening_field'),
                        'closing' => $this->input->post('monday_closing_field')
                    ),
                    array(
                        'area_id' => $last_inserted_id,
                        'day' => 'Tuesday',
                        'opening' => $this->input->post('tuesday_opening_field'),
                        'closing' => $this->input->post('tuesday_closing_field')
                    ),
                    array(
                        'area_id' => $last_inserted_id,
                        'day' => 'Wednesday',
                        'opening' => $this->input->post('wednesday_opening_field'),
                        'closing' => $this->input->post('wednesday_closing_field')
                    ),
                    array(
                        'area_id' => $last_inserted_id,
                        'day' => 'Thursday',
                        'opening' => $this->input->post('thursday_opening_field'),
                        'closing' => $this->input->post('thursday_closing_field')
                    ),
                    array(
                        'area_id' => $last_inserted_id,
                        'day' => 'Friday',
                        'opening' => $this->input->post('friday_opening_field'),
                        'closing' => $this->input->post('friday_closing_field')
                    ),
                    array(
                        'area_id' => $last_inserted_id,
                        'day' => 'Saturday',
                        'opening' => $this->input->post('saturday_opening_field'),
                        'closing' => $this->input->post('saturday_closing_field')
                    ),
                    array(
                        'area_id' => $last_inserted_id,
                        'day' => 'Sunday',
                        'opening' => $this->input->post('sunday_opening_field'),
                        'closing' => $this->input->post('sunday_closing_field')
                    ),
                );

                $value = $this->seats_m->addAreaTimings($area_timings_data);
    ...
    public function updateArea()
    {
        ...
        $this->seats_m->updateArea($area_data, $area_id);

        $area_timings_data = array(
            array(
                'area_id' => $area_id,
                'day' => 'Monday',
                'opening' => $this->input->post('monday_opening_edit_field'),
                'closing' => $this->input->post('monday_closing_edit_field')
            ),
            array(
                'area_id' => $area_id,
                'day' => 'Tuesday',
                'opening' => $this->input->post('tuesday_opening_edit_field'),
                'closing' => $this->input->post('tuesday_closing_edit_field')
            ),
            array(
                'area_id' => $area_id,
                'day' => 'Wednesday',
                'opening' => $this->input->post('wednesday_opening_edit_field'),
                'closing' => $this->input->post('wednesday_closing_edit_field')
            ),
            array(
                'area_id' => $area_id,
                'day' => 'Thursday',
                'opening' => $this->input->post('thursday_opening_edit_field'),
                'closing' => $this->input->post('thursday_closing_edit_field')
            ),
            array(
                'area_id' => $area_id,
                'day' => 'Friday',
                'opening' => $this->input->post('friday_opening_edit_field'),
                'closing' => $this->input->post('friday_closing_edit_field')
            ),
            array(
                'area_id' => $area_id,
                'day' => 'Saturday',
                'opening' => $this->input->post('saturday_opening_edit_field'),
                'closing' => $this->input->post('saturday_closing_edit_field')
            ),
            array(
                'area_id' => $area_id,
                'day' => 'Sunday',
                'opening' => $this->input->post('sunday_opening_edit_field'),
                'closing' => $this->input->post('sunday_closing_edit_field')
            ),
        );

        $value = $this->seats_m->updateAreaTimings($area_timings_data);
    ...
    public function openArea($area_id)
    {
        ...
        $value = $this->seats_m->openArea($data, $area_id);

        if ($value == true) {
            $this->session->set_flashdata('area_open_succ', '<b>Heads up!</b> Area opened successfully.');
            redirect('admin/Seats/areas', 'refresh');
        } else {
            $this->session->set_flashdata('area_open_err', '<b>Oh Snap!</b> Area is not opened. Please try again!');
            redirect('admin/Seats/areas', 'refresh');
        }
    }
    ...
    public function closeArea($area_id)
    {
        ...
        $value = $this->seats_m->closeArea($data, $area_id);

        if ($value == true) {
            $this->session->set_flashdata('area_close_succ', '<b>Heads up!</b> Area closed successfully.');
            redirect('admin/Seats/areas', 'refresh');
        } else {
            $this->session->set_flashdata('area_close_err', '<b>Oh Snap!</b> Area is not closed. Please try again!');
            redirect('admin/Seats/areas', 'refresh');
        }
    }
}
