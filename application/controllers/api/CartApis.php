...
class CartApis extends REST_Controller
{
    ...
    public function add_item_to_cart_post()
    ...
    public function remove_item_from_cart_post()
    { //tested and working fine
    ...
    public function update_item_quantity_in_cart_post()
    { //tested and working fine
    ...
    public function fetch_current_user_cart_items_post()
    { //tested and working fine
    ...
    public function empty_user_cart_post()
    { //tested and working fine
    ...
    public function add_item_note_post()
    { //tested and working fine

        $tokken = $this->post('tokken');
        $item_id = $this->post('item_id');
        $item_note = $this->post('item_note');
        ...
        if (!empty($item_id)) {
            ...
            if (!empty($tokken)) {
                ...
                if (!empty($user_data)) {
                    ...
                    $result = $this->cart_m->addItemNote($user_id, $item_id, $item_note);

                    if ($result == true) {

                        $this->response(array(
                            "status" => 'success',
                            "message" => "Note added to item successfully.",
                        ), REST_Controller::HTTP_OK);
                    } else {
